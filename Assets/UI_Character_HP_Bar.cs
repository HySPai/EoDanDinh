...
namespace SG
{
    public class UI_Character_HP_Bar : UI_StatBar
    {
        ...
        public override void SetStat(int newValue)
        {
            ...
            // GỌI ĐIỀU NÀY Ở ĐÂY TRONG TRƯỜNG HỢP MÁU SỨC KHỎE TỐI ĐA THAY ĐỔI TỪ HIỆU ỨNG NHÂN VẬT/BUFF V.V.
            slider.maxValue = character.characterNetworkManager.maxHealth.Value;

            // CẦN LÀM: CHẠY LOGIC THANH PHỤ (THANH MÀU VÀNG XUẤT HIỆN PHÍA SAU HP KHI BỊ HƯ HẠI)

            // TỔNG SỐ SÁT HẠI NHẬN ĐƯỢC KHI THANH ĐANG HOẠT ĐỘNG
